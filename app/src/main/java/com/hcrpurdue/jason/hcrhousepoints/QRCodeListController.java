...
import Models.Link;
import Utils.QrCodeListAdapter;
import Utils.Singleton;
import Utils.SingletonInterface;

public class QRCodeListController extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.qr_code_list_activity, container, false);
        ...
        qrCodeCreateFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = new QRCreation();
